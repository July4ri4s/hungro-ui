const Donation = () => {
  return (
    <div className=" m-auto flex flex-col w-[90%] text-[#406036db] items-center md:justify-between bg-white rounded-xl md:h-[40rem]">
          ...
          <div className="flex flex-col m-auto bg-white px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[30px] md:px-16 lg:-mr-14">
            ...
            <form>
              <label>
                ...
                <select
                  name="selectedFruit"
                  className=" mt-4 block min-h-[auto] w-full rounded border-2 border-[#406036db]  py-[0.32rem] px-3 "
                >
              ...
              >
                ...
                <input
                  type="text"
                  className=" mb-4 block min-h-[auto] w-full rounded border-2 border-[#406036db]  py-[0.32rem] px-3 "
                  id="exampleInput90"
              ...
              <button
                ...
                className=" my-8 inline-block w-full rounded bg-[#406036db] px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white  transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] lg:mb-0"
              >
                Enviar
              </button>
            </form>
