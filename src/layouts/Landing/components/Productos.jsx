...
return(
    <>
          ...
          <span className="relative whitespace-nowrap">
            ...
            <span className="relative ">Sugerencia </span>
          </span>
          <br />
          de productos
        </h2>
    ...
    <div className=" bg-white h-[480px] w-80 rounded-xl">
      <div className="  ">
      <h2 className=" text-4xl text-center font-semibold leading-tight px-2 pt-5 pb-2 text-[#195527]">
        Productos sin Gluten
        </h2>
        <p className=" text-xl text-center  leading-tight p-1 text-[#195527]">
    ...
    <div className=" bg-white h-[480px] w-80 rounded-xl">
      ...
      <h2 className=" text-4xl text-center font-semibold leading-tight px-2 pt-5 pb-2 text-[#195527]">
        ...
        <p className=" text-xl te;xt-center  leading-tight px-7 p-1 text-[#195527]">
          Actualmente existen más de 10 tipos de leches alternativas a la de vaca. 

        </p>
        <div  className=" " >
        <img className="w-[40%] block object-center mx-auto mt-2" src={sinazucar2} alt="dashboard image" />
        </div>
    ...
    <div className=" bg-white h-[480px] w-80 rounded-xl">
      ...
      <h2 className=" text-4xl text-center font-semibold leading-tight px-2 pt-5 pb-2 text-[#195527]">
        ...
        <p className=" text-xl text-center  leading-tight px-7 p-1 text-[#195527]">
