        ...
        <div className="sm:flex">
          ...
          <div className="flex items-center ml-auto space-x-2 sm:space-x-3">
            <button
              ...
              className="inline-flex items-center justify-center w-1/2 px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-[#587e4c] focus:ring-4 focus:ring-primary-300 sm:w-auto"
            >
              <svg
