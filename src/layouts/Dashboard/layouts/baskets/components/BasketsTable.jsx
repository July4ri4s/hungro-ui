...
const BasketsTable = ({ refetch, searchTerm }) => {
  ...
  const myBaskets = data?.getBaskets?.filter(
    (basket) =>
      basket.organization.id === organizationId &&
      basket.recipient?.toLowerCase().includes(searchTerm.toLowerCase())
  );

  console.log(myBaskets);
          ...
          <div class="relative p-4 w-full max-w-md h-full md:h-auto shadow-2xl">
            <div class="relative p-4 text-center bg-white rounded-lg shadow-2xl">
              ...
              <p class="mb-4 text-gray-500">
                ¿Estás seguro que deseas eliminar esta canasta?
              </p>
