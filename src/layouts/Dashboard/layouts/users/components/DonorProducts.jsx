        ...
        <div className="mt-10 flex flex-wrap -mx-1 lg:-mx-4 ">
          {data?.getProducts &&
            data?.getProducts?.map((product) => (
              <div className="relative flex flex-col text-gray-700 bg-white shadow-custom border w-96 rounded-xl bg-clip-border m-5">
                <div className="relative h-56 m-4  overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
                  <img
