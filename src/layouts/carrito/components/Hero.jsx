...
const Hero = () => {
  return (
    <>
      <section className="bg-white mt-[8rem]">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="flex flex-col items-center md:items-start mr-auto place-self-center lg:col-span-7">
            <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl  text-center md:text-start">
          ...
          <div className=" mt-10 md:mt-0 lg:col-span-5 lg:flex">
            <img
              src={vision}
              alt="mockup"
